...
- 回复 gpt4，可切换至 gpt4 模式。此模式下，每次提问消耗次数10。
...
作者一共有两个公众号：「程序人uncle」和「程序员brother」。这两个公众号功能基本相同，但作者推荐大家使用「程序员brother」，因为它可以出现在微信首页，可以置顶，而且支持简单易操作的菜单栏。
...
为保护用户隐私，对话仅在服务器保存 7 天，重要内容一定一定要记得及时保存哦。
